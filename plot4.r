...
plot(full.DF$DateTime,full.DF$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(full.DF$DateTime,full.DF$Global_reactive_power,type="l",xlab="datetime",ylab="Global_Reactive_power")
dev.off()